...
* @var backend\models\UserpaySearch $searchModel
*/
...
//if (\Yii::$app->user->can('backend_userpay_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
//}

//if (\Yii::$app->user->can('backend_userpay_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
//}

//if (\Yii::$app->user->can('backend_userpay_delete', ['route' => true])) {
...
<div class="giiant-crud userpay-index">
  ...
  <div class="clearfix crud-navigation">
		<?php
			if(true || \Yii::$app->user->can('backend_userpay_create', ['route' => true])){
		?>
    <div class="pull-left">
