...
$catTypes = GeneralHelper::getCategoriesOfType('sig', false);
...
<div class="signal-form">
  ...
  <div class="">
    ...
    <p>
			<!-- attribute sigcat_id -->
			<?= $form->field($model, 'sigcat_id')->dropDownList($catTypes,
    		// \yii\helpers\ArrayHelper::map(backend\models\Category::find()->all(), 'id', 'cat_title'),
    		[
        	'prompt' => Yii::t('cruds', 'Select'),
        	'disabled' => (isset($relAttributes) && isset($relAttributes['sigcat_id'])),
    		]
			); ?>
