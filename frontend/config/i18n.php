 ...
 * create files, run: ./yii message frontend/config/i18n.php
 */
return [
    'color' => null,
    'interactive' => true,
    'sourcePath' => '@frontend', //'@yii',
    'messagePath' => '@common/frontend_messages', //'@yii/messages',
    'languages' => ['nl-NL'],
    'translator' => 'Yii::t',
    'sort' => true,
    'overwrite' => true,
