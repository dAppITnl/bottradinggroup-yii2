 ...
 * @property \backend\models\Signal[] $sigs
...
abstract class Membership extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return [
            [['mbrcat_id', 'mbr_language', 'mbr_active', 'mbr_order', 'mbr_code', 'mbr_title', 'mbr_roles', 'mbr_createdt', 'mbrusr_created_id', 'mbr_updatedt', 'mbrusr_updated_id'], 'required'],
            [['mbrcat_id', 'mbr_active', 'mbr_order', 'mbr_lock', 'mbrusr_created_id', 'mbrusr_updated_id', 'mbr_deletedat', 'mbrusr_deleted_id'], 'integer'],
            [['mbr_language', 'mbr_roles', 'mbr_cardbody', 'mbr_detailbody', 'mbr_remarks'], 'string'],
            [['mbr_createdt', 'mbr_updatedt', 'mbr_deletedt'], 'safe'],
            [['mbr_code'], 'string', 'max' => 32],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'mbr_updatedt' => Yii::t('models', 'Upadted'),
    ...
    {
        return $this->hasMany(\backend\models\SignalMembership::className(), ['mbr_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\backend\models\Signal::className(), ['id' => 'sig_id'])->viaTable('signal_membership', ['mbr_id' => 'id']);
    }
