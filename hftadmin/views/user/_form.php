...
<div class="user-form">
  ...
  <div class="">
    ...
    <p>
      ...
      <?= '' //$form->field($model, 'usr_sitecsstheme')->hiddenInput(['value' => GeneralHelper::SITECSS_WHITE ])->label(false);
					//$form->field($model, 'usr_sitecsstheme')->dropDownList( $siteCssfiles /*backend\models\User::optsusrsitelevel()*/);
			?>
