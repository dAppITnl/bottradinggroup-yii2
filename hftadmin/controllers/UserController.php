...
//use hftadmin\models\Usermember;
//use hftadmin\models\Userpay;
//use hftadmin\models\Userbot;
//use hftadmin\models\Botsignal;
use RestCord\DiscordClient;

/**
* This is the class for controller "UserController".
*/
class UserController extends \hftadmin\controllers\base\UserController
{
      ...
      'access' => [
        ...
        'rules' => [
          /*[
            ...
            'roles' => ['hftadminMembershipFull'],
          ],
          [
            'allow' => true,
            'actions' => ['index', 'view'],
            'roles' => ['hftadminMembershipView'],
          ],
          [
            'allow' => true,
            'actions' => ['update', 'create', 'delete'],
            'roles' => ['hftadminMembershipEdit'],
          ],*/
          [
