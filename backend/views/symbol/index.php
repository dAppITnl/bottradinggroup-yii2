...
* @var backend\models\SymbolSearch $searchModel
*/
...
//if (\Yii::$app->user->can('backend_symbol_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
//}

//if (\Yii::$app->user->can('backend_symbol_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
//}

//if (\Yii::$app->user->can('backend_symbol_delete', ['route' => true])) {
...
?>
<div class="giiant-crud symbol-index">
  ...
  <h1><?= Yii::t('models.plural', 'Symbol') ?> <small><?= Yii::t('cruds', 'List') ?></small></h1>

  <div class="clearfix crud-navigation">
		<?php if(true || \Yii::$app->user->can('backend_symbol_create', ['route' => true])){ ?>
    <div class="pull-left">
      ...
      'columns' => [
        [
          ...
          'contentOptions' => ['nowrap'=>'nowrap']
			  ...
			  [
	        'attribute'=>'sym_type',
	        'value' => function ($model) use ($symbolTypes) {
	          return $symbolTypes[$model->sym_type]; //backend\models\Symbol::getSymTypeValueLabel($model->sym_type);
	        },
					'filter' => $symbolTypes
        ],
				[
					'attribute' => 'sym_ispair',
          'value' => function ($model) use ($yesNos) {
            return $yesNos[$model->sym_ispair];
          },
          'filter' => $yesNos
				],
        [
          ...
          'value' => function ($model) use ($yesNos) {
            return $yesNos[$model->sym_isquote];
          },
          'filter' => $yesNos
        ],
        'sym_name',
