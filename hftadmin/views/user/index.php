...
$siteLevels = GeneralHelper::getSiteLevels();
...
<div class="giiant-crud user-index">
  ...
  <div class="clearfix crud-navigation">
		...
		?>
      Without login: <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('cruds', 'New'), ['create'], ['class' => 'btn btn-success']) ?> ||
		<?php // } else { ?>
		  With own login: <?= Html::a('<span class="glyphicon glyphicon-plus"></span> ' . Yii::t('cruds', 'Signup'), 'https://bottradinggroup.nl/site/signup', ['class' => 'btn btn-success'] ); ?>.
		<?php // } ?>
		</div>
        ...
        [
          ...
          'buttons' => [
            /*'view' => function ($url, $model, $key) {
              ...
              return Html::a('<span class="glyphicon glyphicon-eye-open">V</span>', $url, $options);
            },*/
