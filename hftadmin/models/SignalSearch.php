...
/**
* SignalSearch represents the model behind the search form about `hftadmin\models\Signal`.
*/
...
$query->andFilterWhere([
            ...
            'sig_deletedat' => 0, //$this->sig_deletedat,
            'sig_deletedt' => $this->sig_deletedt,
            'sigusr_deleted_id' => $this->sigusr_deleted_id,
        ]);

        $query
						->andFilterWhere(['like', 'sigcat_ids', $this->sigcat_ids])
						->andFilterWhere(['in', 'sigcat_ids', Signal::HFTADMIN_CATEGORIES_SIG])
