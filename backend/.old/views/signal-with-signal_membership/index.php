      ...
      <?= \yii\bootstrap\ButtonDropdown::widget(
        [
          ...
          'items' => [
            ...
            [
              'url' => ['signal-membership/index'],
		          'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('models', 'Signal Membership'),
		        ],
            [
              'url' => ['symbol/index'],
    ...
    <?= GridView::widget([
      ...
      'columns' => [
        ...
        [
          ...
          'value' => function($model) use ($getYesNos) { return $getYesNos[ $model->sig_active ]; },
          'filter' => $getYesNos,
        ],
				[
