...
* @var yii\data\ActiveDataProvider $dataProvider
    * @var hftadmin\models\SignalSearch $searchModel
*/
...
//if (\Yii::$app->user->can('hftadmin_signal_view', ['route' => true])) {
    $actionColumnTemplates[] = '{view}';
//}

//if (\Yii::$app->user->can('hftadmin_signal_update', ['route' => true])) {
    $actionColumnTemplates[] = '{update}';
//}

//if (\Yii::$app->user->can('hftadmin_signal_delete', ['route' => true])) {
...
<div class="giiant-crud signal-index">
  ...
  <div class="clearfix crud-navigation">
		<?php if(true || \Yii::$app->user->can('hftadmin_signal_create', ['route' => true])){ ?>
    <div class="pull-left">
