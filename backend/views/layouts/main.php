...
<header>
    ...
    } elseif ($access['backend'] == 'true') {
      $menuItemsLeft = [
				['label' => Yii::t('app', 'General'),
					'items' => [
						['label' => Yii::t('app', 'Categorie'), 'url' => ['/category']],
						['label' => Yii::t('app', 'Symbol'), 'url' => ['/symbol']],
						['label' => Yii::t('app', 'CryptoAdress'), 'url' => ['/cryptoaddress']],
						['label' => Yii::t('app', 'Signal'), 'url' => ['/signal']],
						['label' => Yii::t('app', 'Pricelist'), 'url' => ['/pricelist']],
						['label' => Yii::t('app', 'Membership'), 'url' => ['/membership']],
						['label' => Yii::t('app', 'Signallog'), 'url' => ['/signallog']],
						['label' => Yii::t('app', 'Site theme'), 'url' => ['/site/cssfileform']],
						['label' => Yii::t('app', 'Frontend viewfile'), 'url' => ['/site/viewfileform']],
					]
				],
				['label' => Yii::t('app', 'Clients'),
					'items' => [
						['label' => Yii::t('app', 'User'), 'url' => ['/user']],
						['label' => Yii::t('app', 'Member'), 'url' => ['/usermember']],
						['label' => Yii::t('app', 'Payment'), 'url' => ['/userpay']],
						['label' => Yii::t('app', 'Bot'), 'url' => ['/userbot']],
						['label' => Yii::t('app', 'Bot+Signal'), 'url' => ['/botsignal']],
					]
				],
			];
			$menuItemsRight = [
