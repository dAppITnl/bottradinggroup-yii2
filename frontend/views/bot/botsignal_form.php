...
/*Yii::trace('** view botsignal_form usermemberData: '.print_r($usermemberData, true));
...
$signals = GeneralHelper::getCategorySignalsForUserBotsignal(
	...
	$userbotModel->ubtumb->umbmbr_id,  // $usermember['mbrid'],
	'',
...
function getSignalDescription(id) {
  ...
  try {
    ...
    if (id > 0) {
      $.get(
        '/bot/getsignaldescription?id='+id,
        (response) => {
