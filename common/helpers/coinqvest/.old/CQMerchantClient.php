...
namespace common\helpers\coinqvest;

//include('CQRESTClient.class.php');
//include('CQRESTClientResponseObject.class.php');
//include('CQLoggingService.class.php');
use common\helpers\coinqvest\CQRESTClient;
use common\helpers\coinqvest\CQRESTClientResponseObject;
use common\helpers\coinqvest\CQLoggingService;
...
class CQMerchantClient extends CQRESTClient {
    ...
    private function buildAuthHeaders($path, $method, $params = array()) {
        ...
        curl_close($curl);
        $serverTime = !empty($result) ? $result['time'] : null;
        $timestamp = is_null($serverTime) ? time() : $serverTime;
